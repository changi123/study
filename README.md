...
#### (2) 문제 테스트
####  ㄴ Day를 선택하고 문제를 풀 수 있다. ( 2025-01-06 완료 )
####  ㄴ 정답은 뜻이 여러개일때 그중 하나라도 맞다면 정답 처리 아니라면 오답 ( 스크립트에서 split을 통해 구현함 ) ( 2025-01-06 완료 )
####  ㄴ 틀린 문제는 틀린 횟수가 증가한다. ( 2025-01-06 완료 )
#### (3) 문제 연습
####  ㄴ 문제 테스트와 비슷하지만 틀린 횟수가 증가하지 않는다. ( 2025-01-06 완료 )
####  ㄴ 제출 시 단어 해석 + 예문 + 예문에 들어간 문법 + 내가 해석한 예문과 실제 해석을 비교 할 수 있다. ( 2025-01-06 완료 )
#### (4) 단어에 대한 정보를 추가할 수 있다.  
####  ㄴ 2025-01-02 기준 뜻과 예문은 하나만, 이후 예문도 여러개 가져올 수 있도록 하자 ( 미완료 )
####  ㄴ 단어 추가 사항 ( 단어 + 단어 뜻 + 예문 + 예문 해석 + 예문 문법 + Day ) ( 2025-01-06 완료 )
#### (5) 단어수정
...
# ✔ 25.01.05
#### 1. 문제풀이 ( 정답 체크 + 오답 횟수 업데이트 ) 기능 완료 ( 2025-01-06 완료 )
#### 2. 문제 연습 기능 완료 ( 2025-01-06 완료 )
#### 3. 문제 추가 기능 완료 ( 2025-01-06 완료 )
...
#### 3. 변수명 카멜표기법으로 수정 + HTML파일 스크립트 변수명도 전부 수정 ( 앞으로 처음부터 변수는 카멜, 페이지는 하이픈으로 하자 .. ) ( 2025-01-06 완료 )
#### 4. 문제 마지막 체크 후 index로 이동 ( 2025-01-06 완료 )
#### 5. 추가해야할 것
...
# ✔ 25.01.07
#### 1. 추가해야할 기능
#### ㄴ Day0 - 두 단어 조합으로 만들어진 것만 조회해서 문제 풀기 버튼 index에 추가 ( 미완료 ) 
