...
## 하루 연습할 단어 추가 및 단어 연습 + 테스트 하기 ( 추가한 Day 만큼 영어공부 한것이니 끝까지 채워보자 )
---
...
# ✔ 25.01.14
#### 1. Day10 단어 추가 완료 + Day11 단어 추가 완료 + Day12 단어 추가 완료
#### 2. 모바일 접근 시 practice에서 추가사항 저장 기능은 제거 웹으로 접근 시에만 가능한 반응형으로 변경 ( 2025-01-14 완료 )
---

# ✔ 25.01.15
#### 1. 회원가입 기능 -> 비밀번호 암호화하여 저장완료 ( 2025-01-15 완료 ) 
#### 2. 로그인 시큐리티 설정 수정중 ..
...
# # ✔ 25.01.20
#### 1. firebase로 이전하여 웹호스팅 해보기 생각해보기
---

# # ✔ 25.01.21
#### 1. firebase 이전하지말고 현상태 유지 -> 이 웹프로젝트 활용해서 계속적인 영어공부 -> 다음 웹프로젝트 주제 생각해볼 것 
#### 2. Day16 단어 추가 완료
---
